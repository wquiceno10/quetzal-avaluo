...
export default function AvaluoInmobiliario() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F4F0]">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-[#2C3D37] to-[#1a2620] text-white py-16">
      ...
      {/* Sticky "Mis Avalúos" Button - Top Right */}
      <div className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex justify-end">
          <a
            href="/mis-avaluos"
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#2C3D37] hover:bg-[#1a2620] text-white rounded-full text-sm font-medium transition-colors shadow-md"
          >
