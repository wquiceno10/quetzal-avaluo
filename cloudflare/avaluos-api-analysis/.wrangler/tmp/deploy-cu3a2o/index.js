...
Del siguiente texto, extrae un JSON con los comparables y el an\xE1lisis.

TEXTO:
${perplexityContent}

REGLAS DE EXTRACCI\xD3N:
1. "precio_lista": El n\xFAmero EXACTO del aviso.
...
IMPORTANTE: Extrae TODOS los comparables que encuentres. No filtres por \xE1rea ni precio.

Devuelve SOLO JSON v\xE1lido, sin texto adicional.
        `.trim();
    let extractedData = {};
    try {
