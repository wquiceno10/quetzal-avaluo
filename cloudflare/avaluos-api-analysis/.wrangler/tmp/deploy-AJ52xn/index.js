...
Devuelve SOLO JSON v\xE1lido.
    ...
    try {
      ...
      const nivelConfianza2 = extractedData.nivel_confianza || "Medio";
      const estadisticasComparables = extractedData.estadisticas_comparables || {};
      console.log(`Nivel de confianza: ${nivelConfianza2}`);
    ...
    const comparables = (extractedData.comparables || []).map((c) => {
      ...
      console.log(`[${comparable.titulo}] Validaci\xF3n: ${comparable.fuente_validacion}${comparable.nota_adicional ? " | Nota: " + comparable.nota_adicional.substring(0, 50) : ""}`);
      return comparable;
