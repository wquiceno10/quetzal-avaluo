...
// src/index.js
console.log("Deploy V10 (Refined Logic) - " + (/* @__PURE__ */ new Date()).toISOString());
...
9. VALIDACI\xD3N DE URLS:
   ...
   - NUNCA inventes URLs.
10. Sincronizaci\xF3n de Conteos:
...
1. "comparables": Extrae CADA INMUEBLE del listado (formato multi-l\xEDnea, NO tabla).
   ...
   **Fuente**
   ...
   - "url": Texto despu\xE9s de "url: " (pen\xFAltima l\xEDnea, o null si no existe)
   - "url_estado": Texto despu\xE9s de "url_estado: " (\xFAltima l\xEDnea)
