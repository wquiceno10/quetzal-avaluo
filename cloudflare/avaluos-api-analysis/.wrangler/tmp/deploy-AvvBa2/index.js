...
Luego presenta un listado de **entre 15 a 20 comparables** usando EXACTAMENTE este formato (respeta pipes "|" y saltos de l\xEDnea):

**[T\xEDtulo descriptivo del inmueble]**
[Tipo de inmueble] | [Venta/Arriendo]
$[Precio] | [\xC1rea] m\xB2 | [Hab] hab | [Ba\xF1os] ba\xF1os
[Barrio] | [Ciudad]
**[Fuente]**
...
Apartamento | Venta
$245.000.000 | 68 m\xB2 | 3 hab | 2 ba\xF1os
Condina | Pereira
**Fincaraiz**

IMPORTANTE: 
- Respeta EXACTAMENTE este formato. Usa pipes "|" como separadores.
- Cada l\xEDnea en su propia l\xEDnea.
- Separa cada comparable con una l\xEDnea en blanco.
- Para cada comparable indica si es "Mismo barrio", "Barrio similar" o "Zona cercana" en el t\xEDtulo o descripci\xF3n.
...
1. "comparables": Extrae CADA INMUEBLE del listado (formato multi-l\xEDnea, NO tabla).
   ...
   **Fuente**
   ...
   Extrae:
   - "titulo": Texto entre ** ** de la primera l\xEDnea
   - "tipo_inmueble": Texto antes del | en la segunda l\xEDnea
   ...
   - "barrio": Texto antes del | en la cuarta l\xEDnea
   - "ciudad": Texto despu\xE9s del | en la cuarta l\xEDnea
